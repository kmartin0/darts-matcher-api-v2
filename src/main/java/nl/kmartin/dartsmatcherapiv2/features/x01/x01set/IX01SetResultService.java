...
public interface IX01SetResultService {
    void updateSetResult(X01Set x01Set, int bestOfLegs, List<X01MatchPlayer> players, int x01);

    void updateLegResults(X01Set set, List<X01MatchPlayer> players, int x01);

    List<ObjectId> getSetWinners(X01Set x01Set, int bestOfLegs, List<X01MatchPlayer> players);
